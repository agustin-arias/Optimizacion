...
function gradient_descent(Y, X, G, beta, b)
  err = 10000
  MAX_ITERATIONS = 100
  i = 1
...
# beta, iteraciones = gradient_descent(Y_1, X_1, G_1, beta_inicial, b_1)  # Corregir gradient_descent (o mejorar eleccion de beta_inicial)
...
beta, iteraciones = gradient_descent(Y_2, X_2, G_2, beta_inicial, b_2)  # Corregir gradient_descent (o mejorar eleccion de beta_inicial)
error_beta = norm(beta-beta_hat)^2
